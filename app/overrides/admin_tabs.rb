...
Deface::Override.new(:virtual_path => "spree/admin/shared/_configuration_menu", #"spree/admin/configurations/index",
                     :name => "inquiries_admin_configurations_menu",
                    # :original => "35aede11c44b8ceff0be2d90bafd334d9d9b2ae2",
                     :insert_bottom => "[data-hook='admin_configurations_sidebar_menu']",
                     :text => "<%= configurations_sidebar_menu_item(t('inquiries'), admin_inquiry_settings_path) %>",
                     :disabled => false)
